...
function MatchGame(sessionState, gameState, debug) {
	var _i = this;
...
MatchGame.prototype.allowTurn = function(user) {
	return this.userToPlayer[user] == this.gameState.nextPlayer;
}

MatchGame.prototype.getNextPlayer = function() {
	return this.playerToUser[this.gameState.nextPlayer];
}

MatchGame.prototype.moveSquare = function(from, to) {
	var p = this.getSquare(from);
	this.setSquare(from, null);
	this.setSquare(to, p);
}

MatchGame.prototype.getWinner = function() {
...
MatchGame.prototype.getSquare = function(pos) {
	return this.gameState.board[pos.x + (pos.y << 3)] || { p:null, t:null };
}

MatchGame.prototype.setSquare = function(pos, value) {
...
MatchGame.prototype.lineOpen = function(from, to) {
...
MatchGame.prototype.takeTurn = function(user, turn, validateOnly) {
	var me = this.gameState.nextPlayer;
	var them = (me == 1 ? 2 : 1);
...
MatchGame.createGameState = function(sessionState) {
